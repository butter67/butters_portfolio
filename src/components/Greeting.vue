<template>    
    ...
    <div>
      ...
      <div class="greeting flex flex-col md:flex-row">
          
        <div class="rips hidden md:block w-1/2">
         <img src="../assets/image/rip.png" alt="rips">
        </div>
    ...
    <g id="アートボード1" transform="matrix(0.595238,0,0,0.65619,0,0)">
        <rect x="0" y="0" width="1680" height="1050" style="fill:none;"/>
        <g transform="matrix(1.78733,0,0,1.64985,-520.456,-49.5072)">
        ...
        <g transform="matrix(1.78733,0,0,1.64985,-1584.9,80.1682)">
